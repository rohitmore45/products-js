...
async function displayProducts() {
  ...
  data.forEach(function(prod) {
    ...
    const prodDec = document.createElement('p')
    prodDec.textContent=prod.description;

    const prodCategory = document.createElement('h4')
    ...
    product.appendChild(prodCategory)
    product.appendChild(prodDec) 
    // product.appendChild(prodRating)
